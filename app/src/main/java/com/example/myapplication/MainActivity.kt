...
class MainActivity : AppCompatActivity() {
    ...
    private  fun makeColored(view:View){
        when(view.id){
            ...
            R.id.red_button->binding.boxThreeText.setBackgroundColor(getColor(this, R.color.my_red))
            R.id.yellow_button->binding.boxFiveText.setBackgroundColor(getColor(this, R.color.my_yellow))
            R.id.green_button->binding.boxFourText.setBackgroundColor(getColor(this, R.color.my_green))
